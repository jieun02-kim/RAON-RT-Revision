...
*	Description: Header for the CRC16 class
...
{
public:
    CRC16(uint16_t apolynomial, uint16_t init_value = 0, bool areflect_input = true, bool areflect_output = true, uint16_t axor_output = 0);
    virtual ~CRC16(){};
